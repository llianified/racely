...
const GROUPS: Group[] = [
  ...
  },
  {
    ...
    { key: "missionLapsReward", label: "Hadiah misi ringan", hint: "Sparepart", step: "1" },
    { key: "missionUpgradeTarget", label: "Target misi upgrade", step: "1" },
    { key: "missionUpgradeReward", label: "Hadiah misi sedang", hint: "Sparepart", step: "1" },
    { key: "missionEarnTarget", label: "Target misi koin", step: "1" },
    { key: "missionEarnReward", label: "Hadiah misi besar", hint: "Sparepart", step: "1" },
