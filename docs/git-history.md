...
- Judul commit dan PR tidak memakai suffix nomor PR seperti `(#76)`.
- Untuk setiap commit yang berasal dari PR, simpan atribusi hanya melalui trailer
  setelah satu baris kosong: `Original-PR: #<nomor>`. Commit langsung non-PR
  tidak memakai trailer palsu.
