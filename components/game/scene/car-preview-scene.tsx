...
type CarPreviewProps = { color: string; model?: CarModelId; levels?: GameState['levels']; inspect?: boolean }
...
export default function CarPreviewScene({ color, model, levels, inspect }: CarPreviewProps) {
  return (
    <Canvas
      orthographic
      dpr={[1, 1.25]}
